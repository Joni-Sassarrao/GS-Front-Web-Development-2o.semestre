        ...
        <div className='rounded-3xl shadow-[0_10px_10px_rgba(0,0,0,0.25)] m-5'>
            ...
            <div className="w-full flex flex-col gap-4 p-5 pt-0">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-lg font-semibold text-gray-600 max-[1621px]:text-base">{pessoa.localizacao}</p>
                </div>
                <div className="flex items-center gap-2">
                    <BsBriefcaseFill className="text-gray-800"/>
                    <p className="text-lg font-semibold text-gray-600 max-[1621px]:text-base">{pessoa.cargo}</p>
                </div>
            </div>
